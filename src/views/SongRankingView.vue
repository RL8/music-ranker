<template>
  <div class="p-4 pb-20">
    <h1 class="text-2xl font-bold mb-4">Song Ranking <span class="text-gray-500 text-xl">(i)</span></h1>
    <p class="mb-6">Spec: Tiered layout for ranking songs by preference</p>
    ...
    <div class="mb-6">
      ...
      <div class="flex overflow-x-auto py-2 space-x-4">
        <div class="flex-shrink-0 w-16 h-16 bg-gray-200 rounded-lg flex items-center justify-center border-2 border-green-500">
          <span class="text-xs text-gray-500">Album 1</span>
        </div>
        <div class="flex-shrink-0 w-16 h-16 bg-gray-200 rounded-lg flex items-center justify-center">
          <span class="text-xs text-gray-500">Album 2</span>
        </div>
        <div class="flex-shrink-0 w-16 h-16 bg-gray-200 rounded-lg flex items-center justify-center">
          <span class="text-xs text-gray-500">Album 3</span>
        </div>
        <div class="flex-shrink-0 w-16 h-16 bg-gray-200 rounded-lg flex items-center justify-center">
          <span class="text-xs text-gray-500">Album 4</span>
        </div>
        <div class="flex-shrink-0 w-16 h-16 bg-gray-200 rounded-lg flex items-center justify-center">
          <span class="text-xs text-gray-500">Album 5</span>
        </div>
      </div>
    </div>
    ...
    <div class="mb-8 space-y-6">
      ...
      <div class="border-2 border-green-500 rounded-lg p-4 bg-green-50">
        ...
        <div class="flex justify-center">
          <div class="w-full max-w-xs bg-white rounded-lg p-3 shadow-sm">
      ...
      <div class="border-2 border-red-500 rounded-lg p-4 bg-red-50">
        ...
        <div class="flex flex-col space-y-2">
          ...
          <div class="w-full max-w-xs bg-white rounded-lg p-3 shadow-sm">
            <span class="text-gray-700 font-medium">[Rank #10] Song Title</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="border-2 border-gray-300 rounded-lg p-4 bg-gray-50 mb-6">
      <div class="flex justify-between items-center mb-3">
        ...
        <span class="text-gray-500">[Collapsible Shelf ▼]</span>
      </div>
      
      <div class="flex flex-col space-y-2">
        <div class="bg-white rounded-lg p-3 shadow-sm">
          <span class="text-gray-700">Song 1</span>
        </div>
        <div class="bg-white rounded-lg p-3 shadow-sm">
          <span class="text-gray-700">Song 2</span>
        </div>
        <div class="bg-white rounded-lg p-3 shadow-sm">
          <span class="text-gray-700">Song 3</span>
        </div>
        <div class="bg-white rounded-lg p-3 shadow-sm">
          <span class="text-gray-700">Song 4</span>
        </div>
        <div class="bg-white rounded-lg p-3 shadow-sm">
          <span class="text-gray-700">Song 5</span>
        </div>
      </div>
    </div>
    ...
    <div class="flex flex-col space-y-3 mt-8">
      <button class="w-full p-3 bg-green-600 text-white rounded-lg font-bold hover:bg-green-700 transition-colors">
        Start Song Ranking Session
      </button>
      <button class="w-full p-3 bg-gray-300 text-gray-500 rounded-lg font-bold opacity-50 cursor-not-allowed">
        Save Song Rankings
      </button>
    </div>
  </div>
...
<script setup>
// Component logic will be added in future implementation
</script>
